...
function getRandomUserAgent() {
 ...
 if (process.argv.length < 7){console.log(`Method ddos by bee\n Usage: node fox.js target time rate thread proxy.txt`); process.exit();}
...
console.log(`Methods: fox`)
console.log(`Methods ddos by bee`)
console.log(`--------------------------------------------`)
